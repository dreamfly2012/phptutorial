...
use dreamfly\Publisher as ChildPublisher;
use dreamfly\PublisherQuery as ChildPublisherQuery;
use dreamfly\Map\BookTableMap;
use dreamfly\Map\PublisherTableMap;
 ...
 *
 *
 * @package    propel.generator.dreamfly.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\dreamfly\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of dreamfly\Base\Publisher object.
     */
     ...
     * @return $this|\dreamfly\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\dreamfly\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\dreamfly\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\dreamfly\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \dreamfly\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \dreamfly\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\dreamfly\Book');
    }
