...
use dreamfly\Author as ChildAuthor;
use dreamfly\AuthorQuery as ChildAuthorQuery;
use dreamfly\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \dreamfly\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\dreamfly\\Author', $modelAlias = null)
    {
