...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'dreamfly.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\dreamfly\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'dreamfly.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\dreamfly\\Book');
        $this->setPackage('dreamfly');
    ...
    {
        $this->addRelation('Publisher', '\\dreamfly\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\dreamfly\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \dreamfly\Book) { // it's a model object
