...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'dreamfly.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\dreamfly\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'dreamfly.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\dreamfly\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \dreamfly\Author) { // it's a model object
